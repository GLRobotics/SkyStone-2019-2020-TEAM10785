...
@Autonomous
public class SSAUTO1BlockBlueParkInside extends LinearOpMode {
        ...
        while (opModeIsActive()) {
            ...
            switch (autonomousStep) {
                ...
                case 7: // STRAFE UNDER 14 INCH BAR TO SAME POSITION
                    if (robot.moveStep == 3) {
                        if (stoneLoc.equals("Build")) {
                            robot.movePower = -1.0f*k;
                            robot.moveTarget = (-56.0f+6.0f)*k;
                            robot.strafeHoldAngle(0);
                        } else if (stoneLoc.equals("Center")) {
                            robot.movePower = -1.0f*k;
                            robot.moveTarget =(-56.0f-2.0f)*k;
                            robot.strafeHoldAngle(0);
                        } else {
                            robot.movePower = -1.0f*k;
                            robot.moveTarget = (-56.0f-10.5f)*k;
                            robot.strafeHoldAngle(0);
                        }
                        autonomousStep = 9;
                    }
                ...
                case 10: // STRAFE BACK TO SECOND BLOCK AND LINES UP
                    ...
                    robot.movePower=1.0f*k;
                    if (stoneLoc.equals("Build")) {
                        robot.moveTarget = 80.0f*k;
                        autonomousStep=11;
                    } else if (stoneLoc.equals("Center")) {
                        robot.moveTarget = 87.0f*k;
                        autonomousStep=11;
                    } else {
                        robot.moveTarget = 85.0f*k;
                        autonomousStep=111;
                    }
                ...
                case 15://STRAFE UNDER 14 INCH BAR PT 2
                    if(robot.moveComplete()) {
                        if (stoneLoc.equals("Build")) {
                            robot.movePower = -1.0f*k;
                            robot.moveTarget = -81.0f*k;
                            autonomousStep = 16;
                        } else if (stoneLoc.equals("Center")) {
                            robot.movePower = -1.0f*k;
                            robot.moveTarget = -90.0f*k;
                            autonomousStep = 16;
                        }
                        else {
                            robot.movePower = -1.0f*k;
                            robot.moveTarget = -111.0f*k;
                            autonomousStep = 16;
                        }
                        robot.strafeHoldAngle(0);
                    }
