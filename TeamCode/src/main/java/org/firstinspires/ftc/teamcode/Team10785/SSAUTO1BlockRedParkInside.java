...
@Autonomous
public class SSAUTO1BlockRedParkInside extends LinearOpMode {
                ...
                case 15://STRAFE UNDER 14 INCH BAR PT 2
                    if(robot.moveComplete()) {
                        if (stoneLoc.equals("Build")) {
                            ...
                            robot.movePower = -1.0f*k;
                            robot.moveTarget = -91.5f*k;
                            autonomousStep = 16;
                        }
                        else {
                            robot.movePower = -1.0f*k;
                            robot.moveTarget = -105.0f*k;
                            autonomousStep = 16;
                        }
                        robot.strafeHoldAngle(0);
                    }
